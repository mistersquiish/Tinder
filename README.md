...
1. Could not figure out how to animate rotation based on picture y-position selection
2.
...
<img src='https://i.imgur.com/3PKaIfR.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

Could not figure out how to animate rotation based on picture y-position selection
